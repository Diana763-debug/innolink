// DATA contoh — anda boleh tambah atau sambung ke backend kelak
const DATA = {
  ideas:[
  ...
  random:[
    ...
    {title:"Applikasi Pembelajaran", short:"Platform pembelajaran AR untuk pelajar."}
  ]
};

// Simpan idea baru ke localStorage (dipanggil dari upload page)
